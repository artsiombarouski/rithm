...
export type TopTabScreenProps<
  ParamList extends ParamListBase,
  RouteName extends keyof ParamList = keyof ParamList,
  NavigatorID extends string | undefined = undefined,
> = {
  navigation: TopTabNavigationProp<ParamList, RouteName, NavigatorID>;
...
export type TopTabNavigationOptions = HeaderOptions & {
  /**
   ...
   * Gap between tabs
   */
  tabBarGap?: number | string;

  /**
   * Enable / Disable tabs horizontal scroll
   */
   ...
   */
  tabBarButton?: (props: TopTabBarButtonProps) => React.ReactNode;
   ...
   * You'd also need to use `useTopTabBarHeight()` to add a bottom padding to your content.
   */
   ...
   */
  header?: (props: TopTabHeaderProps) => React.ReactNode;
...
export type TopTabNavigationConfig = {
  /**
...
export type TopTabHeaderProps = {
   ...
   */
  options: TopTabNavigationOptions;
  /**
   ...
   */
  navigation: TopTabNavigationProp<ParamListBase>;
};
...
export type TopTabBarButtonProps = Omit<
  TouchableWithoutFeedbackProps,
  'onPress'
> & {
  to?: string;
