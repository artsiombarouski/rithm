...
import AnimatedValueProvider, {
  useAnimatedValues,
} from 'react-native-draggable-flatlist/lib/module/context/animatedValueContext';
import { useStableCallback } from 'react-native-draggable-flatlist/lib/module/hooks/useStableCallback';
import { DEFAULT_PROPS } from 'react-native-draggable-flatlist/lib/module/constants';
import { useAutoScroll } from 'react-native-draggable-flatlist/lib/module/hooks/useAutoScroll';
import DraggableFlatListProvider from 'react-native-draggable-flatlist/lib/module/context/draggableFlatListContext';
import PropsProvider from 'react-native-draggable-flatlist/lib/module/context/propsContext';
import RefProvider, {
  useRefs,
} from 'react-native-draggable-flatlist/lib/module/context/refContext';
import { typedMemo } from 'react-native-draggable-flatlist/lib/module/utils';
import PlaceholderItem from 'react-native-draggable-flatlist/lib/module/components/PlaceholderItem';
import CellRendererComponent from 'react-native-draggable-flatlist/lib/module/components/CellRendererComponent';
import ScrollOffsetListener from 'react-native-draggable-flatlist/lib/module/components/ScrollOffsetListener';
import RowItem from './DraggableFlatListRowItem';
...
function DraggableFlatListInner<T>(props: DraggableFlatListProps<T>) {
  ...
  const dragCancel = useStableCallback(() => {
    if (touchTranslate.value === 0 || !activeKey) {
      reset();
    }
  }, [activeKey]);
